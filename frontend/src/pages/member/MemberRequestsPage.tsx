...
export function MemberRequestsPage() {
  ...
  const [form, setForm] = useState({
    type: 'permission' as AttendanceRequestType,
    date_from: today,
    date_to: today,
  ...
  const correction = isCorrectionType(form.type)
  const partialAbsence = isPartialAbsenceType(form.type)
  const showCheckInField = form.type === 'missed_check_in' || form.type === 'time_correction'
  const showCheckOutField = form.type === 'missed_check_out' || form.type === 'time_correction' || partialAbsence
