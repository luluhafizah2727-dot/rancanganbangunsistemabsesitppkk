    ...
    <div className="member-page">
      ...
      <section className="member-card">
        ...
        <form className="member-form" onSubmit={savePassword}>
          ...
          <label className="field"><span>Password baru</span><input className="input" type="password" minLength={12} value={password.password} onChange={(event) => setPassword({ ...password, password: event.target.value })} required /></label>
