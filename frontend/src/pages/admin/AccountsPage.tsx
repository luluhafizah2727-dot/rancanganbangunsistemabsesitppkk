...
function EditAccountModal({ account, busy, error, onClose, onSubmit }: { account: Account; busy: boolean; error: unknown; onClose: () => void; onSubmit: (values: { name: string; email: string; phone: string; status: Account['status']; role?: Role }) => void }) {
