...
interface ReportPreview {
  ...
  summary: { expected: number; present: number; permission: number; leave: number; sick: number; official_duty: number; absent: number; pending: number; partial_absence: number }
  generated_at: string
}
