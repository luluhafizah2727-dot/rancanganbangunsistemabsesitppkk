...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::create('attendance_days', function (Blueprint $table): void {
            ...
            $table->timestampTz('check_in_target_at')->nullable();
            $table->timestampTz('check_in_opens_at')->nullable();
            $table->timestampTz('check_in_closes_at')->nullable();
            $table->timestampTz('check_out_target_at')->nullable();
            $table->timestampTz('check_out_opens_at')->nullable();
            $table->timestampTz('check_out_closes_at')->nullable();
